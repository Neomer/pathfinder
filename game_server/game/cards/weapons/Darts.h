...
#ifndef GAME_SERVER_DARTS_H
#define GAME_SERVER_DARTS_H

#include "../WeaponCard.h"

class Darts : public ActiveCard
{
public:
    int getTypeId() const override;
};

class DartsMetadata : public WeaponCardMetadata {
public:

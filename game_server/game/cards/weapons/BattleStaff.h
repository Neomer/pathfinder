...
#ifndef GAME_SERVER_BATTLESTAFF_H
#define GAME_SERVER_BATTLESTAFF_H

#include "../WeaponCard.h"

class BattleStaff : public ActiveCard
{
public:
    int getTypeId() const override;
};

class BattleStaffMetadata : public WeaponCardMetadata
{
public:
...
#endif //GAME_SERVER_BATTLESTAFF_H

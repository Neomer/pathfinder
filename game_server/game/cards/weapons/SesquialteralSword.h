...
#ifndef GAME_SERVER_SESQUIALTERALSWORD_H
#define GAME_SERVER_SESQUIALTERALSWORD_H

#include "../WeaponCard.h"

class SesquialteralSword : public ActiveCard
{
public:
    int getTypeId() const override;
};

class SesquialteralSwordMetadata : public WeaponCardMetadata {
public:
...
#endif //GAME_SERVER_SESQUIALTERALSWORD_H

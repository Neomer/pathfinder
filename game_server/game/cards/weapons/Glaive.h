...
#ifndef GAME_SERVER_GLAIVE_H
#define GAME_SERVER_GLAIVE_H

#include "../WeaponCard.h"

class Glaive : public ActiveCard
{
public:
    int getTypeId() const override;
};

class GlaiveMetadata : public WeaponCardMetadata {
public:

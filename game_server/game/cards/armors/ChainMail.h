...
#ifndef GAME_SERVER_CHAINMAIL_H
#define GAME_SERVER_CHAINMAIL_H

#include "../ArmorCard.h"

class ChainMail : public ActiveCard{
public:
    int getTypeId() const override;
};

class ChainMailMetadata : public ArmorCardMetadata
{
public:

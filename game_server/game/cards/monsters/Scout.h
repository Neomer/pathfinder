...
#ifndef GAME_SERVER_SCOUT_H
#define GAME_SERVER_SCOUT_H

#include "../MonsterCard.h"

class Scout : public ActiveCard
{
public:
    int getTypeId() const override;
};

class ScoutMetadata : public MonsterCardMetadata {
public:

...
#ifndef GAME_SERVER_SKELETON_H
#define GAME_SERVER_SKELETON_H

#include "../MonsterCard.h"

class Skeleton : public ActiveCard
{
public:
    int getTypeId() const override;
};

class SkeletonMetadata : public MonsterCardMetadata {
public:

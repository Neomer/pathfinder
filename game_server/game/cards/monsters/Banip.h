...
#ifndef GAME_SERVER_BANIP_H
#define GAME_SERVER_BANIP_H

#include "../MonsterCard.h"

class Banip : public ActiveCard {
public:
    int getTypeId() const override;
};

class BanipMetadata : public MonsterCardMetadata {
public:

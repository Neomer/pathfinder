...
#ifndef GAME_SERVER_PLAGUEZOMBIE_H
#define GAME_SERVER_PLAGUEZOMBIE_H

#include "../MonsterCard.h"

class PlagueZombie : public ActiveCard
{
public:
    int getTypeId() const override;
};

class PlagueZombieMetadata : public MonsterCardMetadata {
public:
...
#endif //GAME_SERVER_PLAGUEZOMBIE_H

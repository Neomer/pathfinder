...
#ifndef GAME_SERVER_GOBLINSABOTEUR_H
#define GAME_SERVER_GOBLINSABOTEUR_H

#include "../MonsterCard.h"

class GoblinSaboteur : public ActiveCard {
public:
    int getTypeId() const override;
};

class GoblinSaboteurMetadata : public MonsterCardMetadata {
public:
...
#endif //GAME_SERVER_GOBLINSABOTEUR_H

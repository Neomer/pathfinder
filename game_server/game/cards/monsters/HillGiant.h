...
#ifndef GAME_SERVER_HILLGIANT_H
#define GAME_SERVER_HILLGIANT_H

#include "../MonsterCard.h"

class HillGiant : public ActiveCard {
public:
    int getTypeId() const override;
};

class HillGiantMetadata : public MonsterCardMetadata {
public:

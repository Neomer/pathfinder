...
#ifndef GAME_SERVER_GHOUL_H
#define GAME_SERVER_GHOUL_H

#include "../MonsterCard.h"

class Ghoul : public ActiveCard {
public:
    int getTypeId() const override;
};

class GhoulMetadata : public MonsterCardMetadata {
public:

...
#ifndef GAME_SERVER_GHOST_H
#define GAME_SERVER_GHOST_H

#include "../MonsterCard.h"

class Ghost : public ActiveCard {
public:
    int getTypeId() const override;
};

class GhostMetadata : public MonsterCardMetadata {
public:
